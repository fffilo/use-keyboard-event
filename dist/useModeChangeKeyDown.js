...
/**
 * React useKeyDown wrapper for key "ModeChange".
 *
 ...
 * @return {Void}
 */
export default function useModeChangeKeyDown(callback, enabled = true, target) {
    useKeyDown("ModeChange", callback, enabled, target);
};
