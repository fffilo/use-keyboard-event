...
/**
 * React useKeyUp wrapper for key "LaunchCalendar".
 *
 ...
 * @return {Void}
 */
export default function useLaunchCalendarKeyUp(callback, enabled = true, target) {
    useKeyUp("LaunchCalendar", callback, enabled, target);
};
