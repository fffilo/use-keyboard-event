...
/**
 * React useKeyDown wrapper for key "Zenkaku".
 *
 ...
 * @return {Void}
 */
export default function useZenkakuKeyDown(callback, enabled = true, target) {
    useKeyDown("Zenkaku", callback, enabled, target);
};
