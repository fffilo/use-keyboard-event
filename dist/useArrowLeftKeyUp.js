...
/**
 * React useKeyUp wrapper for key "ArrowLeft".
 *
 ...
 * @return {Void}
 */
export default function useArrowLeftKeyUp(callback, enabled = true, target) {
    useKeyUp("ArrowLeft", callback, enabled, target);
};
