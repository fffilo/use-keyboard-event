...
/**
 * React useKeyDown wrapper for key "ArrowUp".
 *
 ...
 * @return {Void}
 */
export default function useArrowUpKeyDown(callback, enabled = true, target) {
    useKeyDown("ArrowUp", callback, enabled, target);
};
