...
/**
 * React useKeyUp wrapper for key "AudioVolumeUp".
 *
 ...
 * @return {Void}
 */
export default function useAudioVolumeUpKeyUp(callback, enabled = true, target) {
    useKeyUp("AudioVolumeUp", callback, enabled, target);
};
