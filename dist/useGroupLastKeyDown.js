...
/**
 * React useKeyDown wrapper for key "GroupLast".
 *
 ...
 * @return {Void}
 */
export default function useGroupLastKeyDown(callback, enabled = true, target) {
    useKeyDown("GroupLast", callback, enabled, target);
};
