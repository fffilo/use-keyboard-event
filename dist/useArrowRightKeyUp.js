...
/**
 * React useKeyUp wrapper for key "ArrowRight".
 *
 ...
 * @return {Void}
 */
export default function useArrowRightKeyUp(callback, enabled = true, target) {
    useKeyUp("ArrowRight", callback, enabled, target);
};
