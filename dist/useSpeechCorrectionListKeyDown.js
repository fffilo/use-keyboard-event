...
/**
 * React useKeyDown wrapper for key "SpeechCorrectionList".
 *
 ...
 * @return {Void}
 */
export default function useSpeechCorrectionListKeyDown(callback, enabled = true, target) {
    useKeyDown("SpeechCorrectionList", callback, enabled, target);
};
