...
/**
 * React useKeyUp wrapper for key "MediaTrackPrevious".
 *
 ...
 * @return {Void}
 */
export default function useMediaTrackPreviousKeyUp(callback, enabled = true, target) {
    useKeyUp("MediaTrackPrevious", callback, enabled, target);
};
