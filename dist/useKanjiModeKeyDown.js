...
/**
 * React useKeyDown wrapper for key "KanjiMode".
 *
 ...
 * @return {Void}
 */
export default function useKanjiModeKeyDown(callback, enabled = true, target) {
    useKeyDown("KanjiMode", callback, enabled, target);
};
