...
/**
 * React useKeyUp wrapper for key "MediaFastForward".
 *
 ...
 * @return {Void}
 */
export default function useMediaFastForwardKeyUp(callback, enabled = true, target) {
    useKeyUp("MediaFastForward", callback, enabled, target);
};
