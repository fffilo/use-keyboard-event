...
/**
 * React useKeyDown wrapper for key "ZoomToggle".
 *
 ...
 * @return {Void}
 */
export default function useZoomToggleKeyDown(callback, enabled = true, target) {
    useKeyDown("ZoomToggle", callback, enabled, target);
};
