...
/**
 * React useKeyDown wrapper for key "ColorF0Red".
 *
 ...
 * @return {Void}
 */
export default function useColorF0RedKeyDown(callback, enabled = true, target) {
    useKeyDown("ColorF0Red", callback, enabled, target);
};
