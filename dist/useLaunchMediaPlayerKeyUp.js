...
/**
 * React useKeyUp wrapper for key "LaunchMediaPlayer".
 *
 ...
 * @return {Void}
 */
export default function useLaunchMediaPlayerKeyUp(callback, enabled = true, target) {
    useKeyUp("LaunchMediaPlayer", callback, enabled, target);
};
