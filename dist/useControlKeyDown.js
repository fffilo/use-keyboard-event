...
/**
 * React useKeyDown wrapper for key "Control".
 *
 ...
 * @return {Void}
 */
export default function useControlKeyDown(callback, enabled = true, target) {
    useKeyDown("Control", callback, enabled, target);
};
