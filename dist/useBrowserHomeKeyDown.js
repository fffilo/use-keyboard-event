...
/**
 * React useKeyDown wrapper for key "BrowserHome".
 *
 ...
 * @return {Void}
 */
export default function useBrowserHomeKeyDown(callback, enabled = true, target) {
    useKeyDown("BrowserHome", callback, enabled, target);
};
