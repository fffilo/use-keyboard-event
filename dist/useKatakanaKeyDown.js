...
/**
 * React useKeyDown wrapper for key "Katakana".
 *
 ...
 * @return {Void}
 */
export default function useKatakanaKeyDown(callback, enabled = true, target) {
    useKeyDown("Katakana", callback, enabled, target);
};
