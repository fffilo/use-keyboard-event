...
/**
 * React useKeyUp wrapper for key "BrowserRefresh".
 *
 ...
 * @return {Void}
 */
export default function useBrowserRefreshKeyUp(callback, enabled = true, target) {
    useKeyUp("BrowserRefresh", callback, enabled, target);
};
